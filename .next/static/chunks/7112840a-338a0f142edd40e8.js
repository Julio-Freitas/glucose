 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let gS=/^__.*__$/;class gT{constructor(a,b,c){this.data=a,this.fieldMask=b,this.fieldTransforms=c}toMutation(a,b){return null!==this.fieldMask?new b8(a,this.data,this.fieldMask,b,this.fieldTransforms):new b7(a,this.data,b,this.fieldTransforms)}}class gU{constructor(a,b,c){this.data=a,this.fieldMask=b,this.fieldTransforms=c}toMutation(a,b){return new b8(a,this.data,this.fieldMask,b,this.fieldTransforms)}}function gV(a){switch(a){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw u()}}class gW{constructor(a,b,c,d,e,f){this.settings=a,this.databaseId=b,this.wt=c,this.ignoreUndefinedProperties=d,void 0===e&&this.Xc(),this.fieldTransforms=e||[],this.fieldMask=f||[]}get path(){return this.settings.path}get Zc(){return this.settings.Zc}ta(a){return new gW(Object.assign(Object.assign({},this.settings),a),this.databaseId,this.wt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ea(a){var b;let c=null===(b=this.path)|| void 0===b?void 0:b.child(a),d=this.ta({path:c,na:!1});return d.sa(a),d}ia(a){var b;let c=null===(b=this.path)|| void 0===b?void 0:b.child(a),d=this.ta({path:c,na:!1});return d.Xc(),d}ra(a){return this.ta({path:void 0,na:!0})}oa(a){return g9(a,this.settings.methodName,this.settings.ua||!1,this.path,this.settings.ca)}contains(a){return void 0!==this.fieldMask.find(b=>a.isPrefixOf(b))|| void 0!==this.fieldTransforms.find(b=>a.isPrefixOf(b.field))}Xc(){if(this.path)for(let a=0;a<this.path.length;a++)this.sa(this.path.get(a))}sa(a){if(0===a.length)throw this.oa("Document fields must not be empty");if(gV(this.Zc)&&gS.test(a))throw this.oa('Document fields cannot begin and end with "__"')}}class gX{constructor(a,b,c){this.databaseId=a,this.ignoreUndefinedProperties=b,this.wt=c||e1(a)}aa(a,b,c,d=!1){return new gW({Zc:a,methodName:b,ca:c,path:P.emptyPath(),na:!1,ua:d},this.databaseId,this.wt,this.ignoreUndefinedProperties)}}function gY(a){let b=a._freezeSettings(),c=e1(a._databaseId);return new gX(a._databaseId,!!b.ignoreUndefinedProperties,c)}function gZ(a,b,c,d,e,f={}){let g=a.aa(f.merge||f.mergeFields?2:0,b,c,e);g5("Data must be an object, but it was:",g,d);let h=g3(d,g),i,j;if(f.merge)i=new ay(g.fieldMask),j=g.fieldTransforms;else if(f.mergeFields){let k=[];for(let l of f.mergeFields){let m=g6(b,l,c);if(!g.contains(m))throw new w(v.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);ha(k,m)||k.push(m)}i=new ay(k),j=g.fieldTransforms.filter(a=>i.covers(a.field))}else i=null,j=g.fieldTransforms;return new gT(new a4(h),i,j)}class g$ extends null{_toFieldTransform(a){if(2!==a.Zc)throw 1===a.Zc?a.oa(`${this._methodName}() can only appear at the top level of your update data`):a.oa(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return a.fieldMask.push(a.path),null}isEqual(a){return a instanceof g$}}function g_(a,b,c){return new gW({Zc:3,ca:b.settings.ca,methodName:a._methodName,na:c},b.databaseId,b.wt,b.ignoreUndefinedProperties)}class g0 extends null{_toFieldTransform(a){return new bZ(a.path,new bR)}isEqual(a){return a instanceof g0}}function g1(a,b,c,d=!1){return g2(c,a.aa(d?4:3,b))}function g2(a,b){if(g4(a=(0,i.m9)(a)))return g5("Unsupported field value:",b,a),g3(a,b);if(a instanceof gQ)return function(a,b){if(!gV(b.Zc))throw b.oa(`${a._methodName}() can only be used with update() and set()`);if(!b.path)throw b.oa(`${a._methodName}() is not currently supported inside arrays`);let c=a._toFieldTransform(b);c&&b.fieldTransforms.push(c)}(a,b),null;if(void 0===a&&b.ignoreUndefinedProperties)return null;if(b.path&&b.fieldMask.push(b.path),a instanceof Array){if(b.settings.na&&4!==b.Zc)throw b.oa("Nested arrays are not supported");return function(a,b){let c=[],d=0;for(let e of a){let f=g2(e,b.ra(d));null==f&&(f={nullValue:"NULL_VALUE"}),c.push(f),d++}return{arrayValue:{values:c}}}(a,b)}return function(a,b){if(null===(a=(0,i.m9)(a)))return{nullValue:"NULL_VALUE"};if("number"==typeof a)return bM(b.wt,a);if("boolean"==typeof a)return{booleanValue:a};if("string"==typeof a)return{stringValue:a};if(a instanceof Date){let c=K.fromDate(a);return{timestampValue:cF(b.wt,c)}}if(a instanceof K){let d=new K(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:cF(b.wt,d)}}if(a instanceof gR)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof gP)return{bytesValue:cG(b.wt,a._byteString)};if(a instanceof gF){let e=b.databaseId,f=a.firestore._databaseId;if(!f.isEqual(e))throw b.oa(`Document reference is for database ${f.projectId}/${f.database} but should be for database ${e.projectId}/${e.database}`);return{referenceValue:cI(a.firestore._databaseId||b.databaseId,a._key.path)}}throw b.oa(`Unsupported field value: ${gB(a)}`)}(a,b)}function g3(a,b){let c={};return ar(a)?b.path&&b.path.length>0&&b.fieldMask.push(b.path):aq(a,(a,d)=>{let e=g2(d,b.ea(a));null!=e&&(c[a]=e)}),{mapValue:{fields:c}}}function g4(a){return!("object"!=typeof a||null===a||a instanceof Array||a instanceof Date||a instanceof K||a instanceof gR||a instanceof gP||a instanceof gF||a instanceof gQ)}function g5(a,b,c){var d;if(!g4(c)||"object"!=typeof(d=c)||null===d||Object.getPrototypeOf(d)!==Object.prototype&&null!==Object.getPrototypeOf(d)){let e=gB(c);throw"an object"===e?b.oa(a+" a custom object"):b.oa(a+" "+e)}}function g6(a,b,c){if((b=(0,i.m9)(b))instanceof gO)return b._internalPath;if("string"==typeof b)return g8(a,b);throw g9("Field path arguments must be of type string or ",a,!1,void 0,c)}let g7=RegExp("[~\\*/\\[\\]]");function g8(a,b,c){if(b.search(g7)>=0)throw g9(`Invalid field path (${b}). Paths must not contain '~', '*', '/', '[', or ']'`,a,!1,void 0,c);try{return new gO(...b.split("."))._internalPath}catch(d){throw g9(`Invalid field path (${b}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,a,!1,void 0,c)}}function g9(a,b,c,d,e){let f=d&&!d.isEmpty(),g=void 0!==e,h=`Function ${b}() called with invalid data`;c&&(h+=" (via `toFirestore()`)"),h+=". ";let i="";return(f||g)&&(i+=" (found",f&&(i+=` in field ${d}`),g&&(i+=` in document ${e}`),i+=")"),new w(v.INVALID_ARGUMENT,h+a+i)}function ha(a,b){return a.some(a=>a.isEqual(b))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * call.
 */ function hp(a,b,c){return a?c&&(c.merge||c.mergeFields)?a.toFirestore(b,c):a.toFirestore(b):b}function hq(a,b){if((a=getModularInstance(a)).firestore!==b)throw new w(v.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return a}class hr extends ho{constructor(a){super(),this.firestore=a}convertBytes(a){return new gP(a)}convertReference(a){let b=this.convertDocumentKey(a,this.firestore._databaseId);return new gF(this.firestore,null,b)}}function hs(a){a=gC(a,gG);let b=gC(a.firestore,gK),c=gM(b),d=new hr(b);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function a(b){if("L"===b.limitType&&0===b.explicitOrderBy.length)throw new w(v.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(a._query),(function a(b,c,d={}){let e=new x;return b.asyncQueue.enqueueAndForget(async()=>(function(a,b,c,d,e){let f=new gp({next:c=>{b.enqueueAndForget(()=>fI(a,g)),c.fromCache&&"server"===d.source?e.reject(new w(v.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):e.resolve(c)},error:a=>e.reject(a)}),g=new fM(c,f,{includeMetadataChanges:!0,Du:!0});return fH(a,g)})(await gw(b),b.asyncQueue,c,d,e)),e.promise})(c,a._query).then(c=>new hh(b,d,a,c)))}function ht(a,b,c){a=gC(a,gF);let d=gC(a.firestore,gK),e=hp(a.converter,b,c);return hu(d,[gZ(gY(d),"setDoc",a._key,e,null!==a.converter,c).toMutation(a._key,b_.none())])}function hu(a,b){return function(a,b){let c=new x;return a.asyncQueue.enqueueAndForget(async()=>{var d;return fY(await (d=a,gv(d).then(a=>a.syncEngine)),b,c)}),c.promise}(gM(a),b)}!function(a,b=!0){var c;n=f.Jn,(0,f.Xd)(new g.wA("firestore",(a,{options:c})=>{let d=a.getProvider("app").getImmediate(),e=new gK(d,new A(a.getProvider("auth-internal")),new E(a.getProvider("app-check-internal")));return c=Object.assign({useFetchStreams:b},c),e._setSettings(c),e},"PUBLIC")),(0,f.KN)(l,"3.4.14",void 0),(0,f.KN)(l,"3.4.14","esm2017")}()}}])